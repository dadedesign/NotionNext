...
const BLOG = {
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || 'Gao DadE', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || 'Salute to the masters of art', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://https://notion-next-9ksy.vercel.app', // 网站地址
